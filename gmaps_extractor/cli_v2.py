...
Entry point for the gmaps-collect-v2 console script.
Mirrors the top-level collect_v2.py for pip-installed usage.
"""
...
Examples:
  ...
  gmaps-collect-v2 "Los Angeles, CA" "restaurants" --enrich --reviews -l 100
  gmaps-collect-v2 "Chicago, IL" "hotels" --workers 30 --enrich-workers 10
  gmaps-collect-v2 "Boston, MA" "dentists" --resume
        """
    )
    ...
    parser.add_argument("--subdivide", action="store_true",
                        help="Use subdivision mode for better coverage")
